...
const server = http.createServer(async (req, res) => {
  // ✅ CAMBIO 1: acepta cualquier origen (o pon tu URL de Render en producción)
  const allowedOrigins = [
    'http://localhost:3001',
    process.env.FRONTEND_URL, // ← tu URL de Render del frontend
  ];
...
// ✅ CAMBIO 2: puerto dinámico desde variable de entorno
